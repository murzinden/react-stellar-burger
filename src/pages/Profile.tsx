...
const Profile: FC = () => {
    ...
    return (
        <form className={cn(s.profile_wrapper)} onSubmit={submitHandler}>
            <nav className={cn(s.profile_list)}>
                <NavLink to={'/profile'} className={cn(s.profile_listEl, "text text_type_main-medium")}>
                    Профиль
                </NavLink>
                <NavLink to={'/line'}
                         className={cn(s.profile_listEl, "text text_type_main-medium text_color_inactive")}>
                    История заказов
                </NavLink>
            ...
            <div>
                ...
                <PasswordInput
                    ...
                    extraClass="mt-6"
                />
                <div className={cn(s.profile_buttons, "mt-6")}>
